...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _showDatepicker: function (input) {
            ...
            var match = /(chrome)[ \/]([\w.]+)/.exec(ua) ||
                ...
                [];
            if (isFixed && match[1].indexOf('opera') > 0) { // correction for Opera when fixed and scrolled
            ...
            if (!inst.inline) {
                ...
                inst.dpDiv.zIndex($(input).zIndex() + 1000000);
        ...
        _generateHTML: function (inst) {
            ...
            if (maxDate) {
                ...
                while (this._daylightSavingAdjust(new this.CDate(drawYear, drawMonth, 1)).getTime() > maxDraw.getTime()) {//[CC]
                    drawMonth--;
                    if (drawMonth < 0) {
                        drawMonth = 11;
                        drawYear--;
            ...
            var match = /(chrome)[ \/]([\w.]+)/.exec(ua) ||
                ...
                ua.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(ua) ||
                [];
            html += buttonPanel + (match[1].indexOf("MSIE") > 0 && parseInt(match[2], 10) < 7 && !inst.inline ?
    ...
    function isArray(a) {
        ...
        var match = /(chrome)[ \/]([\w.]+)/.exec(ua) ||
            ...
            ua.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(ua) ||
            [];
        return (a && ((match[1].indexOf("safari") > 0 && typeof a == 'object' && a.length) ||
